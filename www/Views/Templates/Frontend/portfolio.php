...
<section class="Portfolio">
    <div class="SectionTitle">
        <h4 class="Subheading">Artworks</h4>
        <div class="Content">
            <h2 class="Heading">Explore Our Artists' Works</h2>
            <p class="Text">Discover the Variety of Artists and Their Works</p>
        </div>
    </div>
    <div class="Content">
...
<section class="Portfolio-Layout">
    <div class="Content">
        <div class="Column">
            <h4 class="Subheading">Simplify</h4>
            <h2 class="Heading">Manage and Showcase Your Portfolio with Ease</h2>
        </div>
        <div class="Column">
...
<section class="Portfolio-feedback">
    <div class="SectionTitle">
        <h2 class="Heading">Happy Customers</h2>
        <p class="Text">Read what our customers have to say about us</p>
    </div>
    <div class="Content">
        <div class="Column">
            <div class="Stars">
            ...
            <div class="Avatar">
                <img src="../../../Front-end/Workspace/assets/img/page-portfolio/portrait-1.png" alt="John Doe" class="AvatarImage">
        ...
        <div class="Column">
            ...
            <div class="Avatar">
                <img src="../../../Front-end/Workspace/assets/img/page-portfolio/portrait-2.png" alt="Jane Smith" class="AvatarImage">
                <div class="AvatarContent">
                    <div class="Name">Jane Smith</div>
                    <div class="Role">Musician, XYZ Records</div>
                </div>
                <div class="Divider"></div>
                <div class="CompanyLogo WebflowBlack">
                    <img class="icon" src="../../../Front-end/Workspace/assets/svg/brand/webflow-2.svg">
